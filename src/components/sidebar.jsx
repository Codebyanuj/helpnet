...
function sidebar() {
    return (
        <>
                ...
                <nav class="bg-white border-gray-200 dark:bg-gray-900 w-full">
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
                            <img src="logo.jpg" className="w-12 h-12" alt="Flowbite Logo" />
                            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">HelpNet</span>
                        </a>
            ...
            <div>
                <h1 class="block px-100 text-red-400">Making Your daily Task Easier</h1>
            </div>
